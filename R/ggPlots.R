...
#' @param plot.cens Should the plot include the censored values?
#' @param lty.est The number of survival curves to be generated from the model. 
#' @param lty.ci The number of lines to be generated for confidence intervals. 
#' @param cens.shape The shapes of points plotted, passed to \code{geom_point}
#'
